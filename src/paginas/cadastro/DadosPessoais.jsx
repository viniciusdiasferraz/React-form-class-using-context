...
const DadosPessoais = () => {
  const { usuario, setnomeCompleto, setUf, setCidade, setEmail, setSenha, setSenhaConfirmada, submeterUsuario, possoSelecionarInteresse } = useCadastroUsuarioContext()
